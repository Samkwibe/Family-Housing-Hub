...
import { Home, Eye, EyeOff, Users, Camera, User, Sparkles } from 'lucide-react';
...
export default function Login() {
  ...
  const { login, sendMagicLink, completeMagicLink, userProfile, currentUser } = useAuth();
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mb-2">
                    Use the email on your account, or your US mobile number if you added one at sign-up.
                  </p>
                  ...
                  <>
                    <div className="relative my-6">
                      ...
                      <div className="relative flex justify-center text-sm">
                        <span className="px-4 bg-white/60 backdrop-blur-sm text-gray-600 font-medium">Or</span>
                      </div>
                    </div>
                    <button
                      type="button"
